...
export const getBlocks = async params => {
  ...
  return {
    data: [
      { height: 7234324 + Math.ceil(Math.random(0,1)*100), hash: '01asd7asdj9sadysa0dsa9ysad', txs: Math.ceil(Math.random(0,1)*100) % 10, time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000), proposer: { key: '324esacxz4324vsdkfdsf2f323fs4dsf324', name: 'Binance' }, },
      { height: 7234324 + Math.ceil(Math.random(0,1)*100), hash: '01asd7asdj9sadysa0dsa9ysad', txs: Math.ceil(Math.random(0,1)*100) % 10, time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000), proposer: { key: '324esacxz4324vsdkfdsf2f323fs4dsf324', name: 'Binance' }, },
      { height: 7234324 + Math.ceil(Math.random(0,1)*100), hash: '01asd7asdj9sadysa0dsa9ysad', txs: Math.ceil(Math.random(0,1)*100) % 10, time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000), proposer: { key: '324esacxz4324vsdkfdsf2f323fs4dsf324', name: 'Binance' }, },
      { height: 7234324 + Math.ceil(Math.random(0,1)*100), hash: '01asd7asdj9sadysa0dsa9ysad', txs: Math.ceil(Math.random(0,1)*100) % 10, time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000), proposer: { key: '324esacxz4324vsdkfdsf2f323fs4dsf324', name: 'Binance' }, },
      { height: 7234324 + Math.ceil(Math.random(0,1)*100), hash: '01asd7asdj9sadysa0dsa9ysad', txs: Math.ceil(Math.random(0,1)*100) % 10, time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000), proposer: { key: '324esacxz4324vsdkfdsf2f323fs4dsf324', name: 'Binance' }, },
...
export const getKeygen = async params => {
  ...
  return {
    data: {
      ...
      active_keygen_threshold: 255,
      signing_participation_threshold: 128,
      corruption_signing_threshold: 5,
    }
  }
}
    ...
    data: [
      {
        ...
        time: new Date().getTime() - ((Math.ceil(Math.random(0,1)*100) % 10) * 1000000),
        block: 7234324 + Math.ceil(Math.random(0,1)*100),
        validators: [
          {
