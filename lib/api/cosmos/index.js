      ...
      if (validator_data) {
        if (validator_data.description) {
          if (validator_data.description.identity) {
            if (validatorsData && validatorsData.findIndex(_validator_data => _validator_data.description?.image && _validator_data.operator_address === validator_data.operator_address) > -1) {
