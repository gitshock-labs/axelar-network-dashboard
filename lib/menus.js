...
].map(ex => { return { ...ex, doc_url: `https://docs.axelar.dev/#/Exercises/exercise-${ex?.id}`, submission_url: `https://axelar.knack.com/${process.env.NEXT_PUBLIC_NETWORK_ID}-portal#${process.env.NEXT_PUBLIC_NETWORK_ID}-exercise-${ex?.id}-submission-form/` } })
